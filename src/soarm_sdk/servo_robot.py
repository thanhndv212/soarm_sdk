...
Wraps :class:`~soarm_sdk.hardware_interface.ServoHardwareInterface` and
exposes the :class:`~soarm_sdk.robot.Robot` ABC, satisfying
:class:`~soarm_sdk.interfaces.RobotInterface`.
"""
