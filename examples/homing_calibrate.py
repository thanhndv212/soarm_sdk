...
All calibration logic lives in ``soarm_sdk.calibration`` and
``soarm_sdk.bus``.  This script adds the interactive text-based UI on top.
"""
...
# ---------------------------------------------------------------------------
# Path setup — allows running directly from the examples/ directory without
